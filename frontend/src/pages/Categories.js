...
const SparkleStar = ({ style }) => (
  ...
  >
    <path
      d="M80 0C80 0 84.5 59.5 160 80C160 80 84.5 100.5 80 160C80 160 75.5 100.5 0 80C0 80 75.5 59.5 80 0Z"
      fill="currentColor"
    />
  </svg>
);
    ...
    <div className="min-h-screen bg-[#020617]">
      ...
      <section className="relative pt-36 pb-20 px-6 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=1920&h=800&fit=crop)",
          }}
        />
        ...
        <div className="relative text-center max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-3 mt-8 text-[#64748b] text-sm group relative">
            ...
            {/* Sparkles */}
            <SparkleStar
              style={{ top: "-20px", left: "10%", width: "12px", height: "12px" }}
            />
            <SparkleStar
              style={{
                bottom: "-15px",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filtered.map((cat) => (
              <div
                key={cat.id}
                className={`card-3d ${cat.featured ? "sm:col-span-2 sm:row-span-1" : ""}`}
              >
                <Link
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-z-10 translate-y-3 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <p className="text-[#e2e8f0] text-sm font-medium mb-2 drop-shadow-md">
                      {cat.price}
                    </p>
      ...
      {/* Image Modal */}
      <ImageModal src={modalSrc} open={modalOpen} setOpen={setModalOpen} />
    </div>
  );
};
